                ...
                <?php for ($i = 2; $i <= 4; $i++) : ?>
                    ...
                    <div class="col-lg-4">
                        <div class="card border-0 text-center text-white"><img src="<?= $homeCategories[$i]->getPicture() ?>" alt="Card image" class="card-img">
                            <div class="card-img-overlay d-flex align-items-center">
                                <div class="w-100">
                                    <h2 class="display-4 mb-4"><?= $homeCategories[$i]->getName() ?></h2><a href="<?= $absoluteURL ?>/catalogue/categorie/<?= $homeCategories[$i]->getId() ?>/" class="btn btn-link text-white"><?= $homeCategories[$i]->getSubtitle() ?>
