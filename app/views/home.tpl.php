...
<section>
    <div class="container-fluid">
        <div class="row mx-0">
                ...
                <div class="col-md-6">
                    <div class="card border-0 text-white text-center"><img src="<?= $homeCategories[$i]->getPicture() ?>" alt="Card image" class="card-img">
                        <div class="card-img-overlay d-flex align-items-center">
                            <div class="w-100py-3">
                                <h2 class="display-3 font-weight-bold mb-4"> <?= $homeCategories[$i]->getName() ?></h2><a href="<?= $absoluteURL ?>/catalogue/categorie/<?= $homeCategories[$i]->getId() ?>/" class="btn btn-light"><?= $homeCategories[$i]->getSubtitle() ?></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mx-0">
                <?php for ($i = 2; $i <= 4; $i++) : ?>
                    ...
                    <div class="col-lg-4">
                        <div class="card border-0 text-center text-white"><img src="<?= $homeCategories[$i]->getPicture() ?>" alt="Card image" class="card-img">
                            <div class="card-img-overlay d-flex align-items-center">
                                <div class="w-100">
                                    <h2 class="display-3 font-weight-bold mb-4"> <?= $homeCategories[$i]->getName() ?> </h2> <a href="<?= $absoluteURL ?>/catalogue/categorie/<?= $homeCategories[$i]->getId() ?>/" class="btn btn-link text-white"><?= $homeCategories[$i]->getSubtitle() ?>
                ...
                <div class="card border-0 text-center text-dark">
                    <img src="<?php // echo $absoluteURL 
                                ?>/assets/images/categ1.jpeg" alt="Card image" class="card-img">
                    <div class="card-img-overlay d-flex align-items-center">
                        <div class="w-100">
            ...
            <div class="col-lg-4">
                <div class="card border-0 text-center text-white"><img src="<?php // echo $absoluteURL 
                                                                            ?>/assets/images/categ3.jpeg" alt="Card image" class="card-img">
                    <div class="card-img-overlay d-flex align-items-center">
                        <div class="w-100">
